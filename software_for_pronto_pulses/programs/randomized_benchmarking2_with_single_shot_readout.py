...
class CliffordGates:
    ...
    #CLIFFORDGATES[ii][3] - THE CLIFFORD GATE'S DECOMPOSITION USING JUST: X/2, Z/2
    ...
    _CLIFFORDGATES = [
        ...
        ['H',   'H',    'HZ',   ['Z/2',            'X/2',      'Z/2',           ],np.array([[ 0, 0, 1],[ 0,-1, 0],[ 1, 0, 0]])],
        ['HX',  'HZ',   'H',    ['Z/2',            'X/2',      'Z/2','Z/2','Z/2'],np.array([[ 0, 0,-1],[ 0, 1, 0],[ 1, 0, 0]])],
        ['HY',  'HY',   'HX',   ['Z/2','Z/2','Z/2','X/2',      'Z/2','Z/2','Z/2'],np.array([[ 0, 0,-1],[ 0,-1, 0],[-1, 0, 0]])],
        ['HZ',  'HX',   'HY',   ['Z/2','Z/2','Z/2','X/2',      'Z/2',           ],np.array([[ 0, 0, 1],[ 0, 1, 0],[-1, 0, 0]])],
        ['S',   'SZ',   'SX',   ['Z/2',                                         ],np.array([[ 0,-1, 0],[ 1, 0, 0],[ 0, 0, 1]])],
        ['SX',  'SX',   'SZ',   ['Z/2','Z/2','Z/2','X/2','X/2',                 ],np.array([[ 0, 1, 0],[ 1, 0, 0],[ 0, 0,-1]])],
        ['SY',  'SY',   'S',    ['Z/2',            'X/2','X/2',                 ],np.array([[ 0,-1, 0],[-1, 0, 0],[ 0, 0,-1]])],
        ['SZ',  'S',    'SY',   ['Z/2','Z/2','Z/2'                              ],np.array([[ 0, 1, 0],[-1, 0, 0],[ 0, 0, 1]])],
        ['HS',  'SHX',  'SHZ',  ['Z/2','Z/2',      'X/2',      'Z/2',           ],np.array([[ 0, 0, 1],[-1, 0, 0],[ 0,-1, 0]])],
        ['HSX', 'SHZ',  'SHX',  [                  'X/2',      'Z/2','Z/2','Z/2'],np.array([[ 0, 0,-1],[-1, 0, 0],[ 0, 1, 0]])],
        ['HSY', 'SHY',  'SH',   ['Z/2','Z/2',      'X/2',      'Z/2','Z/2','Z/2'],np.array([[ 0, 0,-1],[ 1, 0, 0],[ 0,-1, 0]])],
        ['HSZ', 'SH',   'SHY',  [                  'X/2',      'Z/2',           ],np.array([[ 0, 0, 1],[ 1, 0, 0],[ 0, 1, 0]])],
        ...
        ['SH',  'HSZ',  'HS',   ['Z/2',            'X/2',      'Z/2','Z/2',     ],np.array([[ 0, 1, 0],[ 0, 0, 1],[ 1, 0, 0]])],
        ['SHX', 'HS',   'HSZ',  ['Z/2',            'X/2',                       ],np.array([[ 0,-1, 0],[ 0, 0,-1],[ 1, 0, 0]])],
        ['SHY', 'HSY',  'HSX',  ['Z/2','Z/2','Z/2','X/2',                       ],np.array([[ 0, 1, 0],[ 0, 0,-1],[-1, 0, 0]])],
        ['SHZ', 'HSX',  'HSY',  ['Z/2','Z/2','Z/2','X/2',      'Z/2','Z/2',     ],np.array([[ 0,-1, 0],[ 0, 0, 1],[-1, 0, 0]])]
    ]
